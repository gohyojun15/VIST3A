...
from third_party_model.anysplat.src.model.encoder.vggt.layers import PatchEmbed
from third_party_model.anysplat.src.model.encoder.vggt.layers.block import Block
from third_party_model.anysplat.src.model.encoder.vggt.layers.rope import (
    PositionGetter,
    RotaryPositionEmbedding2D,
)
from third_party_model.anysplat.src.model.encoder.vggt.layers.vision_transformer import (
    vit_base,
    vit_giant2,
    vit_large,
    vit_small,
...
class Aggregator(nn.Module):
    ...
    def forward(
        self, images: torch.Tensor, intermediate_layer_idx: Optional[List[int]] = None
